...
const systemPrompt = `
    ...
    2. recommendation_agent: Chịu trách nhiệm đưa ra gợi ý sản phẩm dựa trên yêu cầu của người dùng, ví dụ như sản phẩm phổ biến, sản phẩm phù hợp với nhu cầu cụ thể hoặc sản phẩm có đánh giá cao.
    ...
    {
      "decision": "details_agent" hoặc "recommendation_agent". Chọn một trong ba giá trị này và chỉ ghi đúng từ đó.
      "message": ""
    }
\"\"\"`;
