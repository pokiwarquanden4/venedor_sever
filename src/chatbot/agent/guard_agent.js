...
VD: Mình bị đau vai gáy nhiều ngày nay, không ngủ được.
{
  ...
  "message": "Nếu bạn đang cảm thấy đau vai gáy. Bạn có thể tìm các sản phẩm như đai hỗ trợ cổ vai gáy, gối massage, hoặc tinh dầu thư giãn."
}

VD: Mình cần tìm một món quà cho bạn gái
{
  "decision": "not allowed",
  "message": "Nếu bạn cần một món quà cho bạn gái. Bạn có thể tìm các sản phẩm như trang sức, nước hoa, hoặc đồ công nghệ."
}
